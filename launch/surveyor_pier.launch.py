...
# ros2 bag play FIU_BBC_Rat_Neo_clipped/FIU_BBC_Rat_Neo_clipped_0.db3 --clock --start-paused --remap /surveyor/camera/image/image_raw:=/surveyor/camera/image --rate 1.0
...
def generate_launch_description():
    ...
    # Configuration file
    config_file = os.path.join(pkg_dir, 'config', 'config_neoslam_surveyor_pier.yaml')
